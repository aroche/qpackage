...
# translation
SOURCES = qpackage.py ui_qpackage.py __init__.py qpackagedialog.py
#TRANSLATIONS = i18n/qpackage_en.ts
TRANSLATIONS =
...
PY_FILES = qpackage.py qpackagedialog.py __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = ui_qpackage.py
